...
Alabama
	...
	Jason Hadaway(detective) - perjury
	Michael Kilgore(police) - planting drugs
	Christopher Dressel(police) - animal cruelty
	John Barton(police) - arrested caller for no id
	...
	Mark Anthony Whalen(police) - dv
	Mac Bailey Marquette(police) - murder
	Joddie Brooke King(parole) - agg child abuse/assault
	Adam Grant Shipley(police) - intox, harassment, abuse of authority
	Randy Ford Sumner(police) - b&e, assault
	Kevin Walter(police) - sexual assault
	Jarrod Webster(police) - rape, sodomy
	...
	Amber Bolt(police) - lied for Christoper Looser
	Mercedes Rugart(police) - dui
	Alfreda Fluker(police) - murder
	Billy Maurice Driggers(chief) - masturbating in front of teens
	Arthur Maudlin(parole) - dui
	Chris Reed(police) - drugs
	Troy Middlebrooks(police) - proposed murdering black man
	Willy Robinson(chief) - defended Troy Middlebrooks
	Deonte Hamner(police) - sodomy at gunpoint
	Carson Hix(police) - dv
	William Squires(police) - sexual assault of a minor
	Jay Steward(police) - dui homicide
	Paul Callegari(police) - beat handcuffed black man
	Matthew Moore(police) - serial, violent sexual assault
	James Kent(police) - excessive force
	Phillip Champion(police) - excessive force
	Gregory Pimm(police) - excessive force
	Ryan Manning(police) - child abuse, dv
	Daniel Chesser(police) - racist k9
	Robert Golden(police) - assault, menacing, harassment
	Christopher Allen Triplett(police) - rape of a minor
	Christopher Eugene Sanspree Jr(police) - swatting
	Ismael Roldan(police) - rape of child
	William Henry Shields(corrections) - animal cruelty
	Michael Jay Lewis(sheriff) - animal cruelty, attempted murder
	Christopher Whalen(police) - manslaughter
	...
	Joshua Jones(corrections) - negligent homicide, assault
	William Todd(corrections) - stole from inmate
	Jesse Cobb(corrections) - beat inmate
	Ryan Phillips(police) - beat inmate
	Quindarius Thagard(corrections) - smuggling
	Corey McClendon(corrections) - smuggling
	Timothy Lee Scarbrough(corrections) - sodomy
	Corey McClendon(corrections) - smuggling
	Andrew Bailey(corrections) - smuggling
	Charlie Townsend(corrections) - smuggling
	Antwan Giles(corrections) - smuggling
	Timothy Robinson(corrections) - corruption
	Akeem Edmonds(corrections) - beat inmate with belt
	Jeffrey Jackson(corrections) - smuggling
	William Patrick(corrections) - smuggling
	Essence Woods(corrections) - smuggling
	Alex Andrews(corrections) - smuggling
	Andrew Taylor Roy(corrections) - smuggling
	John Paul Ketterman(corrections) - smuggling
	Shamarion Dozier(corrections) - smuggling
	Deaundra Johnson(corrections) - bribery
...
Alaska
	...
	Jason Woodruff(state police) - assault, let dog bite for more than a minute
	Scott Boneta(police) - sexual assault(numerous)
	Jonathan Murphy(police) - assault
	Ronald Monroe Jr(police) - agg dv
	Monte LaVelle Chitty(police) - child sexual abuse
	Ethan Copeland(police) - dui in police car
	Andres Ornelas(police) - sexual abuse of teen
	David Bower(police) - assault
	Nimeron Mike(police) - sex crimes
	Jordan Serafin(police) - assault, burglary
	...
	Rafael Mora-Lopez(police) - identity theft
	Garrett Butler(police) - assault
	Peter Lombardo(police) - dui
	Jalonni Blackshear(corrections) - rape of a minor, murder
	Justin Andrews(corrections) - sexual assault
	Adam Spindler(corrections) - smuggling
	Fredrick Fangonilo(corrections) - sexual assault
	Brianna Andrews(corrections) - smuggling
...
Indiana
	...
	Jaydan Vanosdol(police) - child pornography
	James W Bond(police) - solicitation of a minor
...
Louisiana
	...
	Robert Gisevius Jr(police) - murder
	Anthony Villavaso II (police) - murder
	Robert Faulcon Jr(police) - murder
	Melvin Williams(police) - murder
	David Warren(police) - murder
	Kory York(police) - murder
...
Maine
	...
	Larry Fickett(police) - sexual exploitation of a child
...
Tennessee
	...
	Emmitt Martin(police) - murder, kidnapping
...
Texas
	...
	Darrell Cain(police) - murder of child
